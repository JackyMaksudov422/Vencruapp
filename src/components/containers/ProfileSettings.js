...
const Template = ({
	...
	<div className='app-authenticated-body settings-page profile-hidden'>
		{ selectedImage && 
			<ImageCropper
				image={selectedImage}
				onCancelCrop={fn.handleCancelAvatarCrop}
				onCrop={fn.handleOnCropAvatar}
				width={300}
		...
		<form onSubmit={(event) => fn.handleSubmit(event)}>
    		...
    		<DashboardSection>
    			...
    			<SettingsUserCard
    				newAvatar={newAvatar}
    				hideProfileButton
    				onSelectProfilePicture={fn.handleProfilePictureSelect}
    				onUndoSelectProfilePicture={fn.handleUndoProfilePictureSelect}
    			/>
    		</DashboardSection>
			...
			<div className='spanned text-center mb15 mt-6'>
    			<Button 
    				variant='success'
    				size='sm'
    				children='Save'
